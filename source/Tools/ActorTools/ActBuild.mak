...
CPP=cl.exe
CPP_PROJ=/nologo /MT /W4 /GX /O2 /X /I ".\AStudio" /I ".\AStudio\Util" /I ".\JetSDK\Include" /I ".\ActBuild" /I ".\common" /I ".\fmtactor" /I ".\mkactor" /I ".\mkbody" /I ".\mkmotion" /I ".\mop" /I "..\MsDev60\include" /D "NDEBUG" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "ACTBUILD" /Fp"$(INTDIR)\ActBuild.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=/nologo /subsystem:console /incremental:no /pdb:"$(OUTDIR)\ActBuild.pdb" /machine:I386 /nodefaultlib /out:"$(OUTDIR)\ActBuild.exe" 
LINK32_OBJS= \
	"$(INTDIR)\Log.obj" \
	"$(INTDIR)\maxmath.obj" \
	"$(INTDIR)\mkactor.obj" \
...
CPP=cl.exe
CPP_PROJ=/nologo /MTd /W4 /Gm /GX /ZI /Od /X /I ".\AStudio" /I ".\AStudio\Util" /I ".\JetSDK\Include" /I ".\ActBuild" /I ".\common" /I ".\fmtactor" /I ".\mkactor" /I ".\mkbody" /I ".\mkmotion" /I ".\mop" /I "..\MsDev60\include" /D "_DEBUG" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "ACTBUILD" /Fp"$(INTDIR)\ActBuild.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=/nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\ActBuild.pdb" /debug /machine:I386 /nodefaultlib /out:"$(OUTDIR)\ActBuild.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\Log.obj" \
	"$(INTDIR)\maxmath.obj" \
	"$(INTDIR)\mkactor.obj" \

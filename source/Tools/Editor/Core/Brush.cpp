...
void Brush_Shear( Brush* pBrush, const jeVec3d * pWorldDistance, SELECT_HANDLE eSizeType, ORTHO_AXIS HAxis, ORTHO_AXIS VAxis, const jeExtBox * pSelectedBounds)
{
	...
	jeVec3d				Translation;
	ORTHO_AXIS			ScaleAxis = (ORTHO_AXIS)0;
...
static jeBoolean Brush_ApplyMatrCB( jeBrush_Face *pFace, void * pVoid )
{
	...
	if( UndoContext != NULL )
		Undo_AddSubTransaction( pFaceInfoData->pUndo, (UNDO_FUNCTIONS)UNDO_APPLYMATERIAL, (Object*)pFaceInfoData->pBrush, UndoContext );
...
static jeBoolean Brush_MoveVertCB(Vert_Struct *pData, void *lParam)
{
...
static jeBoolean Brush_RestoreVertCB(Vert_Struct *pData, void *lParam)
{
	Vert_Struct	*	pVert =  (Vert_Struct*)pData;
	Brush		*	pBrush = ( Brush* )lParam;
	jeVertArray *	pArray;

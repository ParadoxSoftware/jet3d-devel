...
LightIterator LightList_Find( LightList * pLightList, Light * pLight )
{
	...
	List_Search( pLightList->pList, LightList_FindCB, pLight, (void**)&pFoundLight, &pBI ) ;
	return pBI ;
...
void LightList_Remove( LightList * pLightList, Light * pLight )
{
	...
	bFound = List_Search( pLightList->pList, LightList_FindCB, pLight, (void**)&pFoundLight, &pBI ) ;
...
int32 LightList_EnumLights( LightList * pLightList, void * pVoid, LightListCB Callback )
{
	...
	return List_ForEach( pLightList->pList, (List_ForEachCallback)Callback, pVoid ) ;
